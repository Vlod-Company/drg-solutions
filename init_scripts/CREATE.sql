...
ALTER TABLE weapons DROP CONSTRAINT IF EXISTS chk_weapon_status;
...
ALTER TABLE logistics DROP CONSTRAINT IF EXISTS chk_logistics_status;

ALTER TABLE weapons
    ADD CONSTRAINT chk_weapon_status
        CHECK (status IN ('STORED','RESERVED','ON_THE_WAY','LOST'));

ALTER TABLE resources
    ADD CONSTRAINT chk_resources_status
        CHECK (status IN ('STORED','RESERVED','ON_THE_WAY','LOST','MINED'));
...
ALTER TABLE logistics
    ADD CONSTRAINT chk_logistics_status
        CHECK (status IN ('CREATED','READY','SHIPPING','SHIPPED','CANCELED'));
...
CREATE INDEX idx_biomes_planet_id ON biomes (planet_id);

DROP INDEX IF EXISTS idx_biomes_delivery_point_id;
CREATE INDEX idx_biomes_delivery_point_id ON biomes (delivery_point_id);

DROP INDEX IF EXISTS idx_warehouses_delivery_point_id;
CREATE INDEX idx_warehouses_delivery_point_id ON warehouses (delivery_point_id);
...
CREATE INDEX idx_stations_delivery_point_id ON stations (delivery_point_id);

DROP INDEX IF EXISTS idx_cargos_ship_to_point;
CREATE INDEX idx_cargos_ship_to_point ON cargos (ship_to_point);

DROP INDEX IF EXISTS idx_teams_cargo_id;
CREATE INDEX idx_teams_cargo_id ON teams (cargo_id);

DROP INDEX IF EXISTS idx_missions_biome_id;
CREATE INDEX idx_missions_biome_id ON missions (biome_id);
...
CREATE INDEX idx_equipment_located_at ON equipment (located_at);

DROP INDEX IF EXISTS idx_equipment_cargo_id;
CREATE INDEX idx_equipment_cargo_id ON equipment (cargo_id);

DROP INDEX IF EXISTS idx_equipment_status_date;
CREATE INDEX idx_equipment_status_date ON equipment (status, date);

DROP INDEX IF EXISTS idx_weapons_located_at;
CREATE INDEX idx_weapons_located_at ON weapons (located_at);

DROP INDEX IF EXISTS idx_weapons_cargo_id;
CREATE INDEX idx_weapons_cargo_id ON weapons (cargo_id);

DROP INDEX IF EXISTS idx_weapons_status_date;
CREATE INDEX idx_weapons_status_date ON weapons (status, date);

DROP INDEX IF EXISTS idx_resources_located_at;
CREATE INDEX idx_resources_located_at ON resources (located_at);

DROP INDEX IF EXISTS idx_resources_status_date;
CREATE INDEX idx_resources_status_date ON resources (status, date);

DROP INDEX IF EXISTS idx_logistics_cargo_id;
CREATE INDEX idx_logistics_cargo_id ON logistics (cargo_id);

DROP INDEX IF EXISTS idx_logistics_space_ship_id;
CREATE INDEX idx_logistics_space_ship_id ON logistics (space_ship_id);

DROP INDEX IF EXISTS idx_employees_status;
CREATE INDEX idx_employees_status ON employees (status);

DROP INDEX IF EXISTS idx_employees_fired_date;
CREATE INDEX idx_employees_fired_date ON employees (fired_date);

DROP INDEX IF EXISTS idx_system_settings_param_name;
CREATE UNIQUE INDEX idx_system_settings_param_name ON system_settings (param_name);
