...
-- Запросы
INSERT INTO requests (sender_department, recipient_department, request_code, description, sender_employee_id, created_at)
VALUES
('Logistics', 'Armory', 'REQ-001', 'Request additional Boomsticks', 1, '2025-10-19 14:00:00'),
('Engineering', 'Supply Chain', 'REQ-002', 'Need more Ziplines', 4, '2025-10-19 14:00:00'),
('Field Ops', 'Medical', 'REQ-003', 'Emergency medpack resupply', 2, '2025-10-19 14:00:00'),
('Command', 'Logistics', 'REQ-004', 'Priority delivery to Drop Pod', NULL, '2025-10-19 14:00:00'),
('Armory', 'Engineering', 'REQ-005', 'Repair parts for Flamethrowers', 3, '2025-10-19 14:00:00');
